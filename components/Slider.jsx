...
//   return (
//     <section className="text-white px-28 pt-20  relative">
//         {/* shower */}
//       <div className="relative ">
//         <div
//           ref={scrollRef}
//           className="flex overflow-auto hidescroll gap-7 mt-12"
//         >
//           {items.map((card) => (
//             <div
//               key={card.id}
//               className="w-[223px] rounded-lg flex-shrink-0 relative"
//             >
//               <img
//                 src={card.imgSrc}
//                 alt={card.title}
//                 className="w-full h-[299px] object-cover rounded-md"
//               />
//             </div>
//           ))}
//         </div>
...
//             className="absolute -right-14 top-1/2 transform -translate-y-1/2 w-10 h-10 cursor-pointer"
//           />
//         )}
//         {canScrollLeft && (
//           <ChevronLeft
//             onClick={() => scroll("left")}
//             className="absolute -left-14 top-1/2 transform -translate-y-1/2 w-10 h-10 cursor-pointer"
//           />
//         )}
//       </div>
//     </section>
